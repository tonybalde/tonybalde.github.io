...
function changeToDarkMode(){
    switch(mode){
        case 0:
            ...
            document.getElementById('download_icon').style.filter = "invert(98%) sepia(48%) saturate(0%) hue-rotate(204deg) brightness(120%) contrast(100%)";  
            document.getElementById('cv__btn___h2').style.border = "thin solid #fff";
            document.getElementById('cv__btn').style.backgroundColor = "#222";
            document.getElementById('cv__btn').style.color = "#fff";
            document.getElementById('resume___btn').style.backgroundColor = "#222";
            document.getElementById('resume___btn').style.color = "#fff";
            document.getElementById('download__cv').style.color="#fff";
